...
export default function Home() {
  return (
    <div className="relative w-full h-[100dvh] overflow-hidden flex flex-col bg-background selection:bg-primary/30">
      ...
      <div className="orb orb-1 opacity-50" style={{ zIndex: -5 }} />
      <div className="orb orb-2 opacity-50" style={{ zIndex: -5 }} />
      <div className="orb orb-3 opacity-40" style={{ zIndex: -5 }} />
      ...
      {[
        ...
        <div key={`pulse-${i}`} className="absolute w-2 h-2 rounded-full bg-primary animate-pulse" style={{ ...pos, zIndex: -4 }}>
          <div className="absolute inset-0 rounded-full bg-primary animate-ping opacity-100" />
        </div>
      ))}

      {/* ── Decorative concentric rings (Animated) ── */}
      <div className="ornament-ring absolute -top-32 -right-32 w-[420px] h-[420px]" style={{ zIndex: -4, animation: 'spin 40s linear infinite' }} />
      <div className="ornament-ring absolute -top-20 -right-20 w-[280px] h-[280px]" style={{ zIndex: -4, animation: 'spin 30s linear infinite reverse' }} />
      <div className="ornament-ring absolute -top-6 -right-6 w-[160px] h-[160px]" style={{ zIndex: -4, animation: 'spin 20s linear infinite' }} />

      <div className="ornament-ring absolute -bottom-28 -left-28 w-[360px] h-[360px]" style={{ zIndex: -4, animation: 'spin 50s linear infinite reverse' }} />
      <div className="ornament-ring absolute -bottom-14 -left-14 w-[220px] h-[220px]" style={{ zIndex: -4, animation: 'spin 25s linear infinite' }} />

      {/* ── Floating geometric SVG ornaments ── */}
      <svg className="absolute top-16 left-6 opacity-30" style={{ zIndex: -4, animation: 'spin 20s linear infinite' }} width="80" height="80" viewBox="0 0 80 80">
      ...
      <svg className="absolute bottom-24 right-8 opacity-30" style={{ animation: "orbFloat2 12s ease-in-out infinite", zIndex: -4 }} width="60" height="60" viewBox="0 0 60 60">
      ...
      <svg className="absolute top-1/2 right-4 -translate-y-1/2 opacity-25" style={{ animation: "orbFloat1 15s ease-in-out infinite", zIndex: -4 }} width="50" height="50" viewBox="0 0 50 50">
      ...
      {[[15, 55], [85, 25], [70, 70], [25, 35], [50, 85]].map(([x, y], i) => (
        <svg key={`plus-${i}`} className="absolute opacity-40" style={{ left: `${x}%`, top: `${y}%`, zIndex: -4, animation: `orbFloat${(i % 3) + 1} ${8 + i * 2}s ease-in-out infinite` }} width="20" height="20" viewBox="0 0 16 16">
